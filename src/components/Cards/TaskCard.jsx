...
const TaskCard = ({
  ...
  const getStatusTagColor = () => {
    ...
    // NEW: Priority color function with RED for High
  const getPriorityTagColor = () => {
    switch (priority) {
      case "High":
        return "text-red-600 bg-red-50 border border-red-500/20";
      case "Medium":
        return "text-yellow-600 bg-yellow-50 border border-yellow-500/20";
      case "Low":
        return "text-green-600 bg-green-50 border border-green-500/20";
      default:
        return "text-gray-600 bg-gray-50 border border-gray-500/20";
    }
  };
  return (
    <div
  ...
  >
    ...
    <p className="text-[13px] text-gray-700/80 font-medium mt-2 mb-2 leading-[18px]">
      <span className="font-semibold text-gray-700">
        Task Done: {completedTodoCount || 0} / {todoCheckList?.length || 0}
      </span>
    </p>
